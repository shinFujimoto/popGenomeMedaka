...
popstatRegion <- read.table("D:/GoogleDrive/study/ò_ï∂å¥çe/0_medakaPopGenomics/DatasetAndScript/genomescan/formatting_output/gene_Info_ensembl/sak40_pi_tajimaD_sexFst_F_d/genomescan_windows_sak40_pi_tajimaD_sexFst_Fd_summaryWindow.txt")
